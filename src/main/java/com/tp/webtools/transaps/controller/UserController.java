...
import com.tp.webtools.transaps.model.UserGeneric;
...
public class UserController {
	 public static final Logger logger = LoggerFactory.getLogger(UserController.class);
	    ...
	    public ResponseEntity<?> createUser(@RequestBody User user, UriComponentsBuilder ucBuilder) {
	        ...
	        user = UserFactory.transformUser(user.getType(), user);
	        
	        if(user == null) {
	        	logger.error("Unable to create. User type undefined");
	            return new ResponseEntity(new CustomError("Unable to identify the user type"), HttpStatus.UNPROCESSABLE_ENTITY);
	        }
