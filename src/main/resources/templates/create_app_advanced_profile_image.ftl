<div id="profile_image_upload_container">
	...
	<div id="profile_image_upload_menu" class="mdl-shadow--2dp">
		...
		<button id="preview_crop_photo_button" type="button" class="mdl-button mdl-js-button mdl-button--icon" ng-click="iconPreview($event)">
			<md-tooltip>Preview app icon</md-tooltip>
		  	<i class="material-icons">visibility</i>
		</button>
		<button id="upload_profile_photo_button" type="button" class="mdl-button mdl-js-button mdl-button--icon">
