        ...
        <div class="panel-body">
            <div class="formcontainer">
                ...
                <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="col-md-2 control-lable" for="user_type">User Type</label>
                            <div class="col-md-7">
                                <select class="form-control" type="text" ng-model="ctrl.user.type" id="type" required ng-disabled="ctrl.user.id">
